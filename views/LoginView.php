...
<div class="container" id ="content">
    ...
    <div class="container">
       <form method='post' action="index.php?controller=account&action=loginPost">
           ...
           <h5> <label for="inputuser" class="sr-only">Email </label></h5>
           
            <input type="email" id="inputuser" name="email"  required="" >
            <br>
            <h5><label  class="sr-only">Mật khẩu</label></h5>
            ...
            <p class="mt-3 mb-3 text-muted">Bạn chưa có tài khoản ?<br>
            <a style="text-decoration:none;" href ="index.php?controller=account&action=register"> Đăng ký tại đây ! </p>
...
<div class="container_swap">
	...
	<a href="https://play.google.com/store/apps/details?id=com.mu.muclubapp&hl=en" class="text-decoration:none;">Google Play</a>
	</button>
