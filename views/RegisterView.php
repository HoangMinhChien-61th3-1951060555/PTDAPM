...
<head>
    ...
    <link rel="stylesheet" href="./assets/admin/css/login1.css">
</head>
<body>
...
<div class="container" id ="content">
  ...
  <div class="row">
    ...
    <div class="container">
        <form class="form-signin" action="index.php?controller=account&action=registerPost" method="post">

            <h1 class="h3 mb-5 font-weight-normal">Đăng ký tài khoản</h1>
            <label for="inputuser" class="sr-only">Họ và tên</label>
            <input type="text" id="inputten" name="name" class="form-control" placeholder="Name" required autofocus>
            <label for="inputuser" class="sr-only">Email</label>
            <input type="text" id="inputuser" name="email" class="form-control" placeholder="Email or phone number" required autofocus>
            <label for="" class="sr-only">Địa chỉ:</label>
            <input type="text"  name="address" class="form-control"  required>
            <label for="" class="sr-only">Điện thoại:</label>
            ...
            <p class="mt-5 mb-3 text-muted">Bạn đã có tài khoản ? <a style="text-decoration:none;" href ="index.php?controller=account&action=login"> Đăng nhập </p>
        </form>
        </div>
    </div>
  </div>    
