<?php 
	trait UsersModel{
		...
		public function modelGetRecord($id){
			...
			$query = $conn->prepare("select * from admin where id=:var_id");
		...
		public function modelUpdate($id){
			...
			//lay bien ket nio csdl
			$conn = Connection::getInstance();
			$query = $conn->prepare("update admin set name = :var_name where id=:var_id");
			//thuc thi truy van, co truyen tham so vao cau lenh sql
			...
			if($password != ""){
				...
				$query = $conn->prepare("update admin set password = :var_password where id=:var_id");
				//thuc thi truy van, co truyen tham so vao cau lenh sql
		...
		public function modelCreate(){
			...
			//lay bien ket nio csdl
			$conn = Connection::getInstance();
			$query = $conn->prepare("insert into admin set name = :var_name, email = :var_email, password = :var_password");
			//thuc thi truy van, co truyen tham so vao cau lenh sql
		...
		public function modelDelete($id){
			//lay bien ket nio csdl
			$conn = Connection::getInstance();
			$query = $conn->prepare("delete from admin where id = :var_id");
			//thuc thi truy van, co truyen tham so vao cau lenh sql
			$query->execute(["var_id"=>$id]);		
		}
	}
